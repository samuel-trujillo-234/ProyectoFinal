...
ALTER TABLE `db_noticias`.`denuncias_noticias` 
CHARACTER SET = utf8 , COLLATE = utf8_general_ci , RENAME TO  `db_noticias`.`reports_noticias` ;

ALTER TABLE `db_noticias`.`denuncias_comentarios` 
CHARACTER SET = utf8 , COLLATE = utf8_general_ci , RENAME TO  `db_noticias`.`reports_comentarios` ;
