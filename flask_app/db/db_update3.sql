...
ALTER TABLE `db_noticias`.`noticias` 
CHARACTER SET = utf8 , COLLATE = utf8_general_ci ,
CHANGE COLUMN `keywords` `keywords` VARCHAR(200) NOT NULL ,
CHANGE COLUMN `hechos` `hechos` VARCHAR(1000) NOT NULL ,
CHANGE COLUMN `sesgo` `sesgo` VARCHAR(1000) NOT NULL ;
