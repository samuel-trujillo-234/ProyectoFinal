...
ALTER TABLE `db_noticias`.`reports_noticias` 
DROP FOREIGN KEY `fk_usuarios_has_noticias_noticias2`;

ALTER TABLE `db_noticias`.`reports_comentarios` 
DROP FOREIGN KEY `fk_usuarios_has_comentarios_comentarios1`;
...
ALTER TABLE `db_noticias`.`reports_noticias` 
CHARACTER SET = utf8 , COLLATE = utf8_general_ci ,
CHANGE COLUMN `usuarios_id` `usuario_id` INT(11) NOT NULL ,
CHANGE COLUMN `noticias_id` `noticia_id` INT(11) NOT NULL ;

ALTER TABLE `db_noticias`.`reports_comentarios` 
CHARACTER SET = utf8 , COLLATE = utf8_general_ci ,
CHANGE COLUMN `usuarios_id` `usuario_id` INT(11) NOT NULL ,
CHANGE COLUMN `comentarios_id` `comentario_id` INT(11) NOT NULL ;
...
ALTER TABLE `db_noticias`.`reports_noticias` 
DROP FOREIGN KEY `fk_usuarios_has_noticias_usuarios2`;

ALTER TABLE `db_noticias`.`reports_noticias` ADD CONSTRAINT `fk_usuarios_has_noticias_usuarios2`
  FOREIGN KEY (`usuario_id`)
  REFERENCES `db_noticias`.`usuarios` (`id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_usuarios_has_noticias_noticias2`
  FOREIGN KEY (`noticia_id`)
  REFERENCES `db_noticias`.`noticias` (`id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;
...
ALTER TABLE `db_noticias`.`reports_comentarios` 
DROP FOREIGN KEY `fk_usuarios_has_comentarios_usuarios1`;

ALTER TABLE `db_noticias`.`reports_comentarios` ADD CONSTRAINT `fk_usuarios_has_comentarios_usuarios1`
  FOREIGN KEY (`usuario_id`)
  REFERENCES `db_noticias`.`usuarios` (`id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_usuarios_has_comentarios_comentarios1`
